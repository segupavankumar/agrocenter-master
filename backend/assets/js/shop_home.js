...
//   // Add to cart
//   obj.addItemToCart = function (name,id, price, count) {
...
//       }
//     }
//     var item = new Item(name,id, price, count);
//     cart.push(item);
//     saveCart();
//   };
//   // Set count from item
...
// var updatebutns = document.getElementsByClassName('add-to-cart')
...
console.log(user)
console.log(item_id)
updateusercart(user_id,quantity,item_id)
  
})}

function updateusercart(user_id,quantity,item_id){
  ...
  fetch(url,{
    ...
    body:JSON.stringify({'quantity':quantity,'item_id':item_id})
    })
